            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                        <?php
//                      в верстке былди разные заголовки h2 и h3 я принял это как ошибку и сделал все с h2
//                      если нужно учитывать именно разный уровень заголовков в массиве могу переделать
                        $articles = [
                        ...
                        foreach ($articles as $header => $article):
                        ?>
                        <h2><?= $header?></h2>
                        <p class="mb-g">
                            <?=$article?>
