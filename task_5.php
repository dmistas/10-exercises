                    ...
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        ...
                        $users = [
                            [
                                ...
                                'web_address' => 'https://wrapbootstrap.com/user/myorange',
                                'contact_name' => 'Sunny',
                            ],
                            [
                                ...
                                'twitter' => '@atlantez',
                                'web_address' => 'https://wrapbootstrap.com/user/Walapa',
                                'contact_name' => 'Jos',
                            ],
                            [
                                ...
                                'role' => 'Partner &amp; Contributor',
                                'twitter' => '@lodev09',
                                'web_address' => 'https://wrapbootstrap.com/user/lodev09',
                                'contact_name' => 'Jovanni',
                            ],
                            [
                                ...
                                'role' => 'Partner &amp; Contributor',
                                'twitter' => '@sildur',
                                'web_address' => 'https://wrapbootstrap.com/user/sildur',
                        ...
                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                            ...
                            <div class="ml-2 mr-3">
                                ...
                                <a href="<?= $user['web_address']?>" class="text-info fs-sm"
                                   target="_blank" title="Contact <?= $user['contact_name']?>"><i class="fal fa-envelope"></i></a>
                            </div>
                        </div>
                        <?php endforeach;?>
                    </div>
